...
public class ImUserviceImpl implements ImUserService {
    ...
    public ResponseVO login(LoginReq req) {
        ...
        if(userDataEntity!=null){
            ...
            zkUserInfoReq.setClientType(req.getClientType());
            ResponseVO zkServer = zkRpcServer.getZkServer(zkUserInfoReq);
            if(zkServer.isOk()){
                Object data = zkServer.getData();
                RpcServerResp rpcServerResp= (RpcServerResp) data;
                userLoginResp.setRpcServerResp(rpcServerResp);
            }
