...
public class UserLoginMessageListener {
            ...
            public void onMessage(CharSequence charSequence, String msg) {
                ...
                for (NioSocketChannel nioSocketChannel : nioSocketChannels) {
                    ...
                    if(loginModel == DeviceMultiLoginEnum.ONE.getLoginMode()){
                        doOfflineOtherOnlineUser(dto, nioSocketChannel, clientType, imei);
                        ...
                        if(isSameClient && !(clientType + ":" + imei).equals(dto.getClientType()+":"+dto.getImei())){
                            sendOfflineCommand(nioSocketChannel);
                        }
                    }
                }
    ...
    private void sendOfflineCommand(NioSocketChannel nioSocketChannel) {
    ...
    private void doOfflineOtherOnlineUser(UserClientDto dto, NioSocketChannel nioSocketChannel, Integer clientType, String imei) {
